  ...
  <b-navbar toggleable="lg" type="dark" class="custom-navbar">
    ...
    <b-collapse id="nav-collapse" is-nav>
      <b-navbar-nav v-show="keys.islogged">
        <!-- Menu Administração -->
        <b-nav-item-dropdown text="Administração" right v-if="keys.TipoUtilizador_Nome === userTypes.ADMINISTRATOR">
          <b-dropdown-item href="#" to="/tipoutilizador">
            <i class="fa fa-user-plus" aria-hidden="true"></i> Tipos de Utilizadores
          </b-dropdown-item>
          ...
          <b-dropdown-item href="#" to="/grupoutilizadores">
            <i class="fa fa-users" aria-hidden="true"></i> Grupos de Utilizadores
          </b-dropdown-item>
        </b-nav-item-dropdown>

        <!-- Menu Gestão -->
        <b-nav-item-dropdown text="Gestão" right v-if="keys.TipoUtilizador_Nome === userTypes.ADMINISTRATOR || keys.TipoUtilizador_Nome === userTypes.GESTOR">
          ...
          <b-dropdown-item href="#" to="/topico">
            <i class="fa fa-microchip" aria-hidden="true"></i> Tópicos de Sensores
          </b-dropdown-item>
        </b-nav-item-dropdown>
      ...
      <b-navbar-nav class="ml-auto" v-show="keys.islogged">
        <b-nav-item-dropdown right v-show="keys.islogged">
          ...
          <b-dropdown-item href="#" :to="{ path: '/perfil/' + keys.Utilizador_ID }">Perfil</b-dropdown-item>
